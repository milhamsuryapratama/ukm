    ...
    <div class="container">
        <table class="table table-striped table-bordered table-hover" id="myTable">
            <thead>
                <tr>
                    <td colspan="11"><a href="<?=base_url()?>seller/tes_produk" class="btn btn-primary">Tambah</a></td>
                </tr>
                <tr align="center">
                    <th>NO</th>
                    <th>Nama Produk</th>
                ...
                $no = 1;
                    foreach ($produk->result() as $prdk) { ?>
                        <tr align="center">
                            ...
                            <td>
                                <a href="<?=base_url()?>seller/edit_produk/<?=$prdk->id_produk?>"><i class="fas fa-edit" style="font-size:20px;color:green"></i></a> 
                                <a href="<?=base_url()?>seller/hapus_produk/<?=$prdk->id_produk?>"><i class="far fa-trash-alt" style="font-size:20px;color:red"></i></a>
                            </td>
                        </tr>
                <?php $no++; } ?>
            </tbody>
